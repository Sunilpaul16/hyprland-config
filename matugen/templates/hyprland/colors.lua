-- Generated by matugen — do not edit by hand, the next `switchwall` run overwrites it
-- Loaded by hyprland.lua after general.lua/rules.lua so these border/accent colours win over the static ones
