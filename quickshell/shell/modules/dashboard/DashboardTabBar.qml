...
Item {
    ...
    component AnimatedTabIndexPair: QtObject {
        ...
        Behavior on idx1 { NumberAnimation { duration: Motion.scaled(100); easing.type: Easing.OutSine } }
        Behavior on idx2 { NumberAnimation { duration: Motion.scaled(300); easing.type: Easing.OutSine } }
    }
}
